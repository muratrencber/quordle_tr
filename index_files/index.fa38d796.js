...
var bt = me((ge) => {
  ...
  const AE =
    ...
    OE = {
      appName: "Dörtle",
      keywords:
        "wordle, quordle, game, puzzle, word, words, letters, play, online, guess, brain teaser, dordle",
      description:
    ...
    rE = {
      ...
      startNewPracticeWarning:
        "Warning: Starting a new game will count as a loss!",
      copySeedToClipboard: "Copy Game Seed to Clipboard",
      copiedSeedToClipboardAlert:
        'Copied practice game seed "%{seed}" to clipboard!',
...
In a moment of evil and genius, <a href='https://github.com/DavidMah' target='_blank' style='text-decoration-line:underline;'>David Mah</a> hacked together the first prototype of Quordle on January 30th and linked it to the group chat. It was truly horrific code (it even had 2 keyboards \u{1F605}), but I knew that I had to continue the madness. With hindsight, he really baited me into finishing his monstrous creation.

Over the next 2 days I improved the code, removed the second keyboard, and added the color quadrant keyboard. I even added Google Analytics thinking it would be funny to see the stats for our friend group playing.

At first it was just a few dozen players (there was a group of 20-30 people in Ohio that were playing constantly the first few days). But then Quordle got written about in an article in <a href='https://www.theguardian.com/games/2022/feb/06/worried-about-losing-wordle-here-are-some-alternatives-just-in-case' target='_blank' style='text-decoration-line:underline;'>The Guardian</a> and things exploded quickly from there. Now Quordle has over 2 million players daily and has had over 15 million total players.
...
I have no plans to monetize Quordle, I just enjoy watching everyone enjoy this insane game and couldn't have done it without Guilherme S. T\xF6ws and David Mah. If you have any ideas for Quordle or just want to chat, check out the socials posted above.`,
      twitter: "Twitter",
      github: "Github",
      facebook: "Facebook",
      reddit: "Reddit",
    ...
    LE = {
      aria: {
        blank: "Blank",
        tileNever:
          "'%{letter}' (letter %{column}) is never guessable (board is complete)",
      ...
      dailyQuordleShare: "Daily Quordle",
      practiceQuordleShare: "Practice Quordle",
      hoursDuration: "in %{smart_count} hour |||| in %{smart_count} hours",
      minutesDuration:
        "in %{smart_count} minute |||| in %{smart_count} minutes",
      secondsDuration:
        "in %{smart_count} second |||| in %{smart_count} seconds",
